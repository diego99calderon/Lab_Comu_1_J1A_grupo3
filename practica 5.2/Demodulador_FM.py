...
# Title: Demodulador_FM
# Author: ModulosJ1A_g2
...
class Demodulador_FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Demodulador_FM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Demodulador_FM")
        ...
        self._Ga_win = RangeWidget(self._Ga_range, self.set_Ga, "AmplitudAudio", "counter_slider", float, QtCore.Qt.Horizontal)
