...
class practica3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "practica3", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("practica3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica3")
        ...
        # Blocks
        ##################################################
        self._freq_range = Range(0, 1e6, 100, 1000, 200)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, amplitud, 0, 0)
