...
class practica5_1_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica5_1_2")
        ...
        self.connect((self.blocks_complex_to_mag_0, 0), (self.calculoPotencia_1, 0))
...
def main(top_block_cls=practica5_1_2, options=None):
